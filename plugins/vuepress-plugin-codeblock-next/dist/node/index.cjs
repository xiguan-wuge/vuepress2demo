...
const getDirname = (importMetaUrl) => utils.path.dirname(url.fileURLToPath(importMetaUrl));

const __dirname$1 = getDirname((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('node/index.cjs', document.baseURI).href)));
...
const demoblockPlugin = ({
  ...
  return {
    ...
    clientConfigFile: utils.path.resolve(__dirname$1, `../client/config${process.env.npm_package_config_configExt || ".mjs"}`),
...
exports.default = demoblockPlugin;
exports.demoblock = demoblock;
exports.demoblockPlugin = demoblockPlugin;
